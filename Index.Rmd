...
knitr::opts_chunk$set(echo = T, comment = "", warning = F, message = F, cache = F, dev = "png", error = T, fig.height=7, fig.width=10)
library(tidyverse)
load('fertility.Rdata')
theme_set(theme_grey() + theme(legend.position = "bottom", legend.title = element_blank(), legend.box = "vertical"))
```
